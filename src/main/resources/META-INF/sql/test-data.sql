...
insert into product (name, manufacturer, productModel, description, price, availability)
values ('HTC Sensation', "HTC", 'Sensation', '5,5', '100',1);
insert into product (name, manufacturer, productModel, description, price)
values ('HTC Titan', "HTC", 'Titan', '6,5', '200');